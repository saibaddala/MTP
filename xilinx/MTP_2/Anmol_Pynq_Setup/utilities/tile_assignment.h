...
#ifndef TENSORFLOW_COMPILER_XLA_HLO_IR_TILE_ASSIGNMENT_H_
#define TENSORFLOW_COMPILER_XLA_HLO_IR_TILE_ASSIGNMENT_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_HLO_IR_TILE_ASSIGNMENT_H_
