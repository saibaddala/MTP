...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_GPU_REDUCTION_UTILS_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_GPU_REDUCTION_UTILS_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_GPU_REDUCTION_UTILS_H_
