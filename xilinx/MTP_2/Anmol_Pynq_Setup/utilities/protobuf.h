...
#include "descriptor.pb.h"         // IWYU pragma:export
#include "arena.h"                // IWYU pragma:export
#include "descriptor.h"           // IWYU pragma:export
#include "dynamic_message.h"      // IWYU pragma:export
#include "coded_stream.h"      // IWYU pragma:export
#include "tokenizer.h"         // IWYU pragma:export
#include "zero_copy_stream.h"  // IWYU pragma:export
#include "zero_copy_stream_impl_lite.h"  // IWYU pragma:export
#include "map.h"                    // IWYU pragma:export
#include "message.h"                // IWYU pragma:export
#include "repeated_field.h"         // IWYU pragma:export
#include "text_format.h"            // IWYU pragma:export
#include "field_comparator.h"  // IWYU pragma:export
#include "json_util.h"         // IWYU pragma:export
#include "message_differencer.h"  // IWYU pragma:export
#include "type_resolver_util.h"  // IWYU pragma:export
