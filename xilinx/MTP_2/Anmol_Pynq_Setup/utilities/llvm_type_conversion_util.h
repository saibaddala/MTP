...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_TYPE_CONVERSION_UTIL_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_TYPE_CONVERSION_UTIL_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_LLVM_IR_LLVM_TYPE_CONVERSION_UTIL_H_
