...
#ifndef TENSORFLOW_COMPILER_XLA_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
#define TENSORFLOW_COMPILER_XLA_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_TRANSLATE_HLO_TO_MHLO_STACK_LOCATION_UTILS_H_
