...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_GPU_OPENXLA_MODULE_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_GPU_OPENXLA_MODULE_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_GPU_OPENXLA_MODULE_H_
