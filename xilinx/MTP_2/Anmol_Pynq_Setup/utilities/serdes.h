...
#ifndef TENSORFLOW_COMPILER_XLA_PYTHON_IFRT_SERDES_H_
#define TENSORFLOW_COMPILER_XLA_PYTHON_IFRT_SERDES_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_PYTHON_IFRT_SERDES_H_
